...
},{"1YiZ5S":3}],5:[function(require,module,exports){
var _  =  require('./lib.imports').lodash;
var Actions = {}, Action;

function Action( typeName ){
    if( _.isString( typeName ) ){
        this.type =  Actions.formatStringForActionType( typeName );
        Object.freeze( this );
    }
    else{
...
Action.prototype = _.create({
    ...
    isEmptyAction: function (){
        return Actions.isEmptyAction( this );
    },
...
Actions = {
    ...
    isEmptyAction: function ( action ){
        return action === Actions.EmptyAction;
    },
...
},{"./lib.imports":8}],6:[function(require,module,exports){
...
},{"./lib.imports":8}],7:[function(require,module,exports){
var Flow = {
...
},{"./actions":5,"./actors":6,"./stages":9,"./streams":10,"./utils":11,"./watchers":12}],8:[function(require,module,exports){
module.exports = {
    Rx          :  require('../node_modules/rx/dist/rx.all.js'),
    lodash      :  require('../libs/lodash.min.3.10.0.js'),
    Immutable   :  require('../libs/immutable.3.7.4.js')
}
},{"../libs/immutable.3.7.4.js":1,"../libs/lodash.min.3.10.0.js":2,"../node_modules/rx/dist/rx.all.js":4}],9:[function(require,module,exports){
var Stages = {
...
},{"./lib.imports":8}],11:[function(require,module,exports){
